...
?>
    ...
    <form class="form" action="" method="POST">
      <h2>Заявка</h2>
      <br />
      Введите имя: <br /><input type="text" name="fio" value="<?php print $values['name']; ?>" pattern="[a-zA-Zа-яА-Я\s]+" title="Имя должно содержать только буквы и пробелы" required>
      <br />
      Введите телефон: <br /> <input type="tel" name="telephone"  value="<?php print $values['phone']; ?>" pattern="/^+?[0-9\s-]*$/" title="Введите корректный номер телефона" required>
      <br />
